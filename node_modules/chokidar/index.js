...
function FSWatcher(_opts) {
  ...
  this._emitReady = function() {
    if (++readyCalls >= this._readyCount) {
      ...
      // use process.nextTick to allow timer for listener to be bound
...
// * timeout - int, duration of timer to suppress duplicate actions
//
...
//
// * path    - string, path being acted upon
// * threshold - int, timer in milliseconds a file size must be fixed before
